...
def main():
    topology = Topology.from_dict(
        {
            ...
            1: {"kind": "worker", "children": []},
            2: {"kind": "worker", "children": []},
            3: {"kind": "worker", "children": []},
        }
    )
    ...
    results = trainer.fit(
        ...
        model=MyCifarModule(),
        data=CifarDataModule(root="~/Research/Data/Torch-Data/", batch_size=32),
    )
